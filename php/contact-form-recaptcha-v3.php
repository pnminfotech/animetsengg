...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
	...
	$secret = '6LdOQ_UaAAAAAOWUjC8pV3u9semZpKEmNnrYVoec';
	...
	if($responseData->success) {
		...
		try {
			...
			$mail->Host = 'mail.cybridge.in';				       // Specify main and backup server
			$mail->SMTPAuth = true;                                  // Enable SMTP authentication
			$mail->Username = 'swapnil@cybridge.in';                    // SMTP username
			$mail->Password = 'Studiowork007_@#';                              // SMTP password
